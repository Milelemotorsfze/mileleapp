            ...
            try {
                ...
                if($id == 'new') {
                    ...
                    if(isset($request->purposes_of_submit)) {
                        ...
                        $history2['message'] = 'Employee passport '.$request->purposes_of_submit.' request send to Employee ( '.$employee->user->name.' - '.$employee->personal_email_adddress.' ) for approval';
