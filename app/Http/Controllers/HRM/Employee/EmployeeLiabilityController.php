...
class EmployeeLiabilityController extends Controller
{
    ...
    public function createOrEdit($id) {
        ...
        $masterEmployees = User::orderBy('name','ASC')->where('status','active')->whereNotIn('id',[1,16,2,26,31,78])->whereHas('empProfile')->with('empProfile.designation','empProfile.department','empProfile.location')->select('id','name')->get();
