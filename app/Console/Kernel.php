...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command('email:send-daily-activity')->dailyAt('18:00')->appendOutputTo(storage_path('logs/user_activity.log'));
        // $schedule->command('email:send-daily-activity')->everyMinute()->appendOutputTo(storage_path('logs/user_activity.log'));
        ...
        $schedule->command('loi-expiry:check')->dailyAt('16:45');
