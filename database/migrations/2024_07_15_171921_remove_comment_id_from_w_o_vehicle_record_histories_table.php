...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('w_o_vehicle_record_histories', function (Blueprint $table) {
            ...
            $foreignKeys = DB::select("SELECT CONSTRAINT_NAME FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE TABLE_NAME = 'w_o_vehicle_record_histories' AND COLUMN_NAME = 'comment_id' AND REFERENCED_TABLE_NAME = 'w_o_comments'");
            ...
            if (Schema::hasColumn('w_o_vehicle_record_histories', 'comment_id')) {
