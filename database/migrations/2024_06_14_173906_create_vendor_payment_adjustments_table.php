...
return new class extends Migration
{
    ...
    {
        Schema::create('vendor_payment_adjustments', function (Blueprint $table) {
            $table->id();
            $table->string('amount')->nullable();
            $table->string('type')->nullable();
            $table->bigInteger('supplier_account_id')->unsigned()->index()->nullable();
            $table->foreign('supplier_account_id')->references('id')->on('suppliers')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('vendor_payment_adjustments');
    }
};
