...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('wo_boe_claims', function (Blueprint $table) {
            ...
            if ($this->indexExists('wo_boe_claims', 'wo_boe_claims_wo_vehicle_id_index')) {
                $table->dropIndex('wo_boe_claims_wo_vehicle_id_index');
            }

            // Drop foreign key and column if they exist
            if (Schema::hasColumn('wo_boe_claims', 'wo_vehicle_id')) {
                $foreignKeyName = $this->getForeignKeyName('wo_boe_claims', 'wo_vehicle_id');
                if ($foreignKeyName) {
