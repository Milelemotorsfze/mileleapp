...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('joining_reports', function (Blueprint $table) {
            ...
            $table->foreign('transfer_from_department_id')->references('id')->on('master_departments')->onDelete('cascade');
            $table->bigInteger('transfer_to_department_id')->unsigned()->index()->nullable()->after('transfer_from_location_id');
            $table->foreign('transfer_to_department_id')->references('id')->on('master_departments')->onDelete('cascade');
        });
