...
class HRMMastersSeeder extends Seeder
{
    ...
    public function run(): void {
        ...
        DB::table('master_departments')->insert([
            ...
            ['id' => 2,'name' => 'Admin Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 3,'name' => 'Business Development','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 4,'name' => 'Chauffeur and Limousine Services','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 5,'name' => 'Corporate Support','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 6,'name' => 'Demand Planning Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],     
            ['id' => 7,'name' => 'ESAO (Enterprise Strategy Analysis Operations) Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 8,'name' => 'Human Resources Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 9,'name' => 'IT Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 10,'name' => 'Logistics Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 11,'name' => 'Marketing Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 12,'name' => 'Procurement Department - Spare Parts Procurement','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 13,'name' => 'QA/QC Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 14,'name' => 'Research and Development Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 15,'name' => 'Sales Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],     
            ['id' => 16,'name' => 'Sales Support Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 17,'name' => 'Vehicle Procurement Department','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 18,'name' => 'Warehouse & Operations','division_id'=> 1,'department_head_id' => 10,'approval_by_id'=>10,'status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
        ]);
