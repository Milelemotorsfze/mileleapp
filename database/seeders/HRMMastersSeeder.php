...
class HRMMastersSeeder extends Seeder
{
    ...
    public function run(): void {
        ...
        DB::table('master_office_locations')->insert([
            ['id' => 1,'name' => 'Head Office','type' => 'office','address' => 'Office No : AF-03, Samari Retail Dubai, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 2,'name' => 'Executive Office','type' => 'office','address' => 'Office No : AF-07, Samari Retail Dubai, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 3,'name' => 'Dubai Showroom 1','type' => 'show_room','address' => 'Showroom 11, Dubai Auto Zone Al Aweer, UAE, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 4,'name' => 'Dubai Showroom 2','type' => 'show_room','address' => 'Showroom 93, Al Aweer Auto Market, Ras Al Khor, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 5,'name' => 'Dubai Showroom 3','type' => 'show_room','address' => 'Showroom 124, Dubai Auto Zone Al Aweer, UAE, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 6,'name' => 'Dubai Showroom 4','type' => 'show_room','address' => 'Showroom 178, Dubai Auto Zone Al Aweer, UAE, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],     
            ['id' => 7,'name' => 'Dubai Showroom 5','type' => 'show_room','address' => 'Showroom 191, Dubai Auto Zone Al Aweer, UAE, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 8,'name' => 'Dubai Yard 1','type' => 'yard','address' => 'Milele Yard, Ras Al Khor Industrial Area 3, UAE, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
            ['id' => 9,'name' => 'Dubai Yard 2','type' => 'yard','address' => 'Jebel Ali Yard, Dubai Logistics City, UAE, United Arab Emirates','contact_number' =>'+97143235991','whatsapp_number' => '+971504996459','status' => 'active','created_by' => 16,'created_at' => Carbon::now()->format('Y-m-d H:i:s'),],
        ]);
