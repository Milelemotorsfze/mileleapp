...
class PermissionTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $Permissions = [
            ...
            ['8','Edit PO Payment','edit-po-payment-details', 'To Edit the PO Payment Details'],
            ['8','Edit PO Colours & VIN','edit-po-colour-details', 'To Edit the PO Colour Details'],
            ['8','Delete PO Details','delete-po-details', 'To Delete the PO Details'],
            ['9','Master Data View','master-view', 'To View the Master Data'],
            ['9','Variant View','variant-view', 'To View the Variant stock details'],
            ['9','Variant edit','variant-edit', 'To Edit the Variant stock details'],
            ['9','Colour View','colour-view', 'To View the Colour details'],
            ['9','Colour Edit','colour-edit', 'To Edit the Colour details'],
            ['9','Vendor View','vendor-view', 'To View the Vendor details'],
            ['9','Vendor Edit','vendor-edit', 'To Edit the Vendor details'],
            ['9','View Stock','stock-full-view', 'To View the stock details'],
            ['9','Edit stock','stock-full-edit', 'To Edit the stock details'],
            ['9','Estimated Arrival','estimated-arrival-view', 'To view the Estimated Arrival'],
            ['9','ETA Timer','ETA-timer-view', 'To view the ETA Timer'],
            ['9','Stock Status','stock-status-view', 'To view the stock status'],
            ['9','SO View','view-so', 'To View The SO Details'],
            ['9','SO Remarks','so-remarks', 'To View The SO Remarks'],
            ['9','PO View','view-po', 'To View The PO Details'],
            ['9','Edit & Create SO','edit-so', 'To Create and Edit the SO'],
            ['9','Approve SO','approve-so', 'To Approve the SO'],
            ['9','Edit Reservation','edit-reservation', 'To Edit Reservation and Select Sales Person'],
            ['9','Approve Reservation','approve-reservation', 'To Approve the Reservation'],
            ...
            ['9','Inspection Approve','inspection-approve', 'To Approve the Inspection Details'],
            ...
            ['9','Reservation View','reservation-view', 'To View the Booking Details'],
            ['9','Remarks','remarks', 'To View, Edit the WareHouse Remarks Details'],
            ...
            ['9','Enginee Edit','enginee-edit', 'To Edit the Enginee Details'],
            ['9','Enginee Approve','engine-approve', 'To Approve the Enginee Details'],
            ['9','PY MM YYYY View','py-mm-yyyy-view', 'To View the PY MM YYYY Details'],
            ...
            ['9','Warehouse view','warehousest-view', 'To View the Territory Details'],
            ['9','warehouse Remarks','warehouse-remarks-view', 'To Edit the Territory Details'],
            ...
            ['11','Warranty Selling Price Histories Edit','warranty-selling-price-histories-edit', 'To Edit List of Warranty Selling Price Histories'],
