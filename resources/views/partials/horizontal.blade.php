                        ...
                        <div class="collapse navbar-collapse menu-container-div " id="topnav-menu-content">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-more">
                                    ...
                                    @endphp
                                    @if($hasPermission OR Auth::user()->hiring_request_approval['can'] == true OR Auth::user()->job_description_approval['can']  == true OR (Auth::user()->interview_summary_report_approval == true && Auth::user()->can_show_summary == true) OR (Auth::user()->candidate_docs_varify > 0 && Auth::user()->can_show_docs == true) OR (Auth::user()->candidate_personal_information_varify > 0 && Auth::user()->can_show_info == true))
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-utility" role="button">
