...
<html>
<head>
    <title>PO Changes Notification</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>PO Changes Notification</h1>
        </div>
        <div class="content">
            <p>Dear Team,</p>
            <p>We are pleased to inform you that the purchase order has been successfully updated. Below are the details:</p>
            <table>
                <tr>
                    <th>PO Number</th>
                    <td>{{ $poNumber }}</td>
