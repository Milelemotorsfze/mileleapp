...
<head>
    <meta charset="utf-8">
    <title>Purchase Order Reservation Cancelled</title>
</head>
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; margin: 0; padding: 20px;">
    <p>Dear {{ $salespersonName }},</p>

    <p>The reservation for the following Purchase Order, previously reserved under your name, has been cancelled.</p>
