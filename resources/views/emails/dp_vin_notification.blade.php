...
<html>
<head>
    <title> Purchased Order VIN Update Notification</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Purchased Order VIN Update</h1>
        </div>
        <div class="content">
            <p>Dear Team,</p>
            <p>We are pleased to inform you that the following vehicle updates have been successfully completed. Below are the details:</p>
            <table>
                <tr>
                    <th>PO Number</th>
                    <td>{{ $poNumber }}</td>
            ...
            <p>Below are the details of the updated vehicles:</p>
            <table>
                <tr>
                    <th>Brand</th>
                    <th>Model Line</th>
                ...
                <tr>
                    ...
                    <td>{{ $vehicle['old_vin'] }}</td>
                    <td>{{ $vehicle['new_vin'] }}</td>
