...
<head>
    <meta charset="utf-8">
    <title>Purchase Order Reservation Reassigned</title>
</head>
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; margin: 0; padding: 20px;">
    <p>Dear {{ $salespersonName }},</p>

    <p>The following Purchase Order is no longer reserved under your name. You have assigned this reservation to <strong>{{ $newSalespersonName }}</strong>.</p>
