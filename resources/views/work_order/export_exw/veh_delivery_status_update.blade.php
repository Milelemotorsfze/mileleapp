                ...
                <form id="vehDeliveryStatusForm_{{$vehicle->id}}">               
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="form-check flex-fill d-flex align-items-left justify-content-left">
                            ...
                            <label class="form-check-label" for="DeliveryDocsHold_{{$vehicle->id}}" style="font-size: 14px;">Delivered With Docs Hold</label>
                        </div>
                    </div>
...
(function() {
    ...
    window.submitVehDeliveryStatus = function(woVehicleId, woNumber, vin) {
        ...
        if (selectedStatus === 'Delivered' && !gdnNumber) {
            alertify.error('Please provide a valid GDN number.');
            return;
        }
        if (selectedStatus === 'Delivered With Docs Hold' && !docsDeliveryDate) {
            alertify.error('Please provide a valid docs delivery date.');
            return;
        }
