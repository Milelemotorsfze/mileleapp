...
<body>
    <div class="card-header">
        <h4 class="card-title">Claim Approved BOE Info</h4>
    </div>
                ...
                <table class="table table-striped table-editable table-condensed my-datatableclass">
                    <thead style="background-color: #e6f1ff">
                        ...
                        <tr>
                            ...
                            <th>
                                <select class="column-filter form-control" id="approved-by-filter" multiple="multiple">
                                    <!-- Options will be dynamically added via JS -->
                                </select>
                            </th>
                            <th></th>
    ...
    $(document).ready(function() {
        @if(isset($datas) && count($datas) > 0)
            ...
            $('#so-filter, #wo-filter, #boe-filter, #claim-reference-number-filter, #approved-by-filter').select2({
            ...
            populateDropdown(6, '#approved-by-filter')

            // Apply multi-select filter for each dropdown
            $('#so-filter, #wo-filter, #boe-filter, #claim-reference-number-filter, #approved-by-filter').on('change', function() {
            ...
            $('#clear-filters').click(function() {
                $('#so-filter, #wo-filter, #boe-filter, #claim-reference-number-filter, #approved-by-filter').val(null).trigger('change');
