...
@endif
@include('vehicles.partials.stock-advanced-filter-bar', ['stockFilterBarTableId' => 'dtBasicExample6'])
...
if (canViewVehicleCost) {
    ...
    columnMap[34] = 'vehicles.custom_inspection_status';
        ...
        data: function (d) {
                ...
                d.bar_filters = (window.stockBarCommitted && window.stockBarCommitted['dtBasicExample6'])
                    ? window.stockBarCommitted['dtBasicExample6'] : {};
    ...
    if (window.stockBarBindTableSummary) {
        window.stockBarBindTableSummary('dtBasicExample6');
    }
...
function exportToExcel(tableId) {
    if (typeof window.exportStockReportToCsv === 'function') {
        window.exportStockReportToCsv(tableId, 'delivered-stock-export.csv');
        return;
    }
