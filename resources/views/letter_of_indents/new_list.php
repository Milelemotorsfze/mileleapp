                            ...
                            <table id="new-LOI-table" class="table table-striped table-editable table-edits table table-condensed" >
                                ...
                                @foreach ($newLOIs as $key => $letterOfIndent)
                                    <tr>
                                        ...
                                        <td>{{ \Illuminate\Support\Carbon::parse($letterOfIndent->created_at)->format('d M Y') ?? '' }}</td>
                                        <td>{{ $letterOfIndent->createdBy->name ?? '' }}</td> 
                                        <td>{{ \Illuminate\Support\Carbon::parse($letterOfIndent->updated_at)->format('d M Y') ?? '' }}</td>
                                        <td>{{ $letterOfIndent->updatedBy->name ?? '' }}</td>
                                        <td>
                                            @can('LOI-approve')
                                                @php
                ...
                <div class="tab-pane fade" id="supplier-response-LOI">
                    <div class="card-body">
                        <div class="tab-pane fade table-responsive" id="supplier-response-LOI">
                            {!! $supplierResponseLOITable->table(['class' => 'table table-bordered table-striped thead-dark']) !!}     
                        </div>
                    </div>
                 </div>
...
@endsection
@push('scripts')
{!! $supplierResponseLOITable->scripts() !!}
