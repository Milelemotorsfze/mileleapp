...
<div class="row" id="fullpage">
    <div class="content">
        ...
        <p style="margin-top: 0px;"> <span class="fw-bold">Address: </span> {{  ucfirst($letterOfIndent->client->country->name) ?? ''}} </p>

        <p>Dear Milele Motors,</p>

        <p>I, ({{ ucfirst($letterOfIndent->client->name) ?? ''}}) am writing this letter to express my sincere intention to purchase the following models from your company.</p>
