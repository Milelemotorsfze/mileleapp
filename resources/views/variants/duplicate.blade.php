            ...
            <option value="RHD" {{ isset($variant) && $variant->steering == 'RHD' ? 'selected' : '' }}>RHD</option>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12" id="variant">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control variant" value= "{{$variant->detail}}" name="variant" id="variant" readonly/>
                                </div>
                            </div>
                ...
                <script>
                    // Bound last so it runs after validation and the variant-details check.
                    ...
                    $(function () {
                        ...
                        $(window).on('pageshow', function () {
                            $('#form-create').data('submitting', false);
