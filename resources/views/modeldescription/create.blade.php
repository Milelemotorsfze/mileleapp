            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 single-input-field">
                    ...
                    <select class="form-control select2" autofocus name="fuel_type" id="fuel" required>
                        ...
                        <option value="Petrol Mild Hybrid" {{ old('fuel_type') == 'Petrol Mild Hybrid' ? 'selected' : '' }}>Petrol Mild Hybrid</option>
                        <option value="Diesel Mild Hybrid" {{ old('fuel_type') == 'Diesel Mild Hybrid' ? 'selected' : '' }}>Diesel Mild Hybrid</option>
                        {{-- <option value="Diesel PHEV" {{ old('fuel_type') == 'Diesel PHEV' ? 'selected' : '' }}>Diesel PHEV</option> --}}
                        <option value="Petrol Hybrid" {{ old('fuel_type') == 'Petrol Hybrid' ? 'selected' : '' }}>Petrol Hybrid</option>
                        <option value="PHEV" {{ old('fuel_type') == 'PHEV' ? 'selected' : '' }}>PHEV (Plug-in Hybrid Electric Vehicle)</option>
