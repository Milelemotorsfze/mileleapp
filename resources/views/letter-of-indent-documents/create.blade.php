    ...
    <div class="card-body">
                ...
                <div class="row" id="deal-doc-upload-div">
                    ...
                    <div class="d-flex">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <input type="file" name="files[]" id="file-upload" class="form-control text-dark" multiple id="file-upload" accept="application/pdf, image/*">
                                </div>
        ...
        <br>
            ...
            <div class="row p-2">
                ...
                <!-- Modal -->
                <div class="modal " id="show-document-{{$letterOfIndentDocument->id}}"  aria-labelledby="exampleModalLabel" >
