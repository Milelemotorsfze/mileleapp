<div class="modal fade" id="approve-passport-release-request-{{$data->id}}"
	tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog ">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="exampleModalLabel">Employee Passport Release Request Approval</h1>
...
<div class="modal fade" id="reject-passport-release-request-{{$data->id}}"
	tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog ">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="exampleModalLabel">Employee Passport Release Request Rejection</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body p-3">
				<div class="col-lg-12">
...
<script type="text/javascript">
	...
	var current_approve_position = $("#current_approve_position_"+id).val();
	     let url = '{{ route('employee-passport-release.request-action') }}';
	     if(status == 'rejected') {
	         var message = 'Reject';
	     }else{
	         var message = 'Approve';
	     }
	     var confirm = alertify.confirm('Are you sure you want to '+ message +' this employee passport release request ?',function (e) {
	         if (e) {
	             $.ajax({
	                 type: "POST",
	                 url: url,
