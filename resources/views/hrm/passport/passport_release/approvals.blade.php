...
<div class="card-header">
	<h4 class="card-title">
		Employee Passport Release Request Approvals By Employee
	</h4>
	@if (count($errors) > 0)
...
<div class="card-header">
	<h4 class="card-title">
		Employee Passport release Request Approvals By Reporting Manager
	</h4>
</div>
<div class="portfolio">
	<ul class="nav nav-pills nav-fill" id="my-tab">
...
<div class="card-header">
	<h4 class="card-title">
		Employee Passport Release Request Approvals By Division Head
	</h4>
</div>
<div class="portfolio">
	<ul class="nav nav-pills nav-fill" id="my-tab">
...
<div class="card-header">
	<h4 class="card-title">
		Employee Passport Release Request Approvals By HR Manager
	</h4>
</div>
<div class="portfolio">
	<ul class="nav nav-pills nav-fill" id="my-tab">
