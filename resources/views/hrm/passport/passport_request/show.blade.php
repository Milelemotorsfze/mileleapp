...
<div class="card-header">
	<h4 class="card-title"> Employee Passport Submit Request Details</h4>
	@if($previous != '')
	...
	<div class="row">
		<div class="col-xxl-6 col-lg-6 col-md-12">
			<div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="card">
					<div class="card-header">
						<h4 class="card-title">Passport Submit Request Details</h4>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-lg-5 col-md-5 col-sm-6 col-12">
							...
							<div class="col-lg-5 col-md-5 col-sm-6 col-12">
								<label for="choices-single-default" class="form-label"> Passport Submit Purpose :</label>
							</div>
							<div class="col-lg-7 col-md-7 col-sm-6 col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-lg-10 col-md-12 col-sm-12">
											@if($data->submit_employee_action_at != '')
											{{ \Carbon\Carbon::parse($data->submit_employee_action_at)->format('d M Y, H:i:s') }}
											@endif
										</div>
										<div class="col-lg-2 col-md-12 col-sm-12">
											Comments :
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-lg-10 col-md-12 col-sm-12">
											@if($data->submit_department_head_action_at != '')
											{{ \Carbon\Carbon::parse($data->submit_department_head_action_at)->format('d M Y, H:i:s') }}
											@endif
										</div>
										<div class="col-lg-2 col-md-12 col-sm-12">
											Comments :
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-lg-10 col-md-12 col-sm-12">
											@if($data->submit_division_head_action_at != '')
											{{ \Carbon\Carbon::parse($data->submit_division_head_action_at)->format('d M Y, H:i:s') }}
											@endif
										</div>
										<div class="col-lg-2 col-md-12 col-sm-12">
											Comments :
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-lg-10 col-md-12 col-sm-12">
											@if($data->submit_hr_manager_action_at != '')
											{{ \Carbon\Carbon::parse($data->submit_hr_manager_action_at)->format('d M Y, H:i:s') }}
											@endif
										</div>
										<div class="col-lg-2 col-md-12 col-sm-12">
											Comments :
