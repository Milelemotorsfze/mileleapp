...
<div class="card-header">
	<h4 class="card-title">Edit Employee Birthday Gift PO</h4>
...
<div class="card-body">
	...
	@endif		
	<form id="employeeBirthdayGiftPOForm" name="employeeBirthdayGiftPOForm" enctype="multipart/form-data" method="POST" action="{{route('birthday_gift.update',$data->id)}}">
		@csrf
		@method("PUT")
		<div class="row">
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-xxl-6 col-lg-6 col-md-6">
						...
						<input type="text" name="po_number" id="po_number" class="form-control widthinput" placeholder="Enter Birthday Gift PO Number"
...
<script type="text/javascript">
	...
	var selectedYear = null;
		selectedYear = Number('{{$data->po_year}}');
