				...
				<div class="col-lg-12">
					<div class="row">
						<div class="col-12">
                            ...
                            <input class="form-check-input" type="checkbox" name="comment_check" id="comment-check-{{$data->id}}">
							...
							<span id="AddonTypeError" class="required-class invalid-feedback">dddd</span>
                            @else
                            <div class="row mt-2">
