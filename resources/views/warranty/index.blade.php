      ...
      <tbody>
        ...
        <tr data-id="1">
          ...
          <td>
            ...
            @endphp
            @if ($hasPermission)
            <button type="button" class="btn btn-danger btn-sm warranty-delete sm-mt-3" data-id="{{ $premium->id }}" data-url="{{ route('warranty.destroy', $premium->id) }}">
            ...
            @if ($hasPermission)
            @if($premium->status == 'active')
            <button title="Make Inactive" data-placement="top" class="btn btn-sm btn-secondary status-inactive-button" data-id="{{ $premium->id }}" data-status="inactive">
