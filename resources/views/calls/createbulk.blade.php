...
<div class="card-body">
    ...
    @endif
    <a style="float: right;" class="btn btn-sm btn-success" href="{{ route('calls.bulkExcelDataUplaod') }}" text-align: right><i class="fa fa-download" aria-hidden="true"></i> Download Sample File</a>
    <br>
    <div class="row">
    </div>
