    ...
    <div class="content">
        ...
        <table id="details">
            ...
            <tr style="color: #02023f">
                ...
                <td>
                    {{ $quotation->currency ." ". number_format($totalAmount, 2) }}
                </td>
            </tr>
            ...
            <tr style="color: #643702;">
                <td style="padding-left: 40px;"><span style="font-weight: bold;margin-right: 5px;"> {{ $key+1 }}. </span>
                    {{ $addon->quotationItem->description ?? ''}}
                </td>
                @if($quotationDetail->cb_name)
            ...
            <tr style="color: #643702">
                <td><span style="font-weight: bold;margin-right: 5px;"> {{ $key+1 }}. </span>
                    {{ $otherVehicleAddon->quotationItem->description ?? ''}}
                </td>
                @if($quotationDetail->cb_name)
            ...
            <tr style="color: #643702">
                <td><span style="font-weight: bold;margin-right: 5px;"> {{ $key+1 }}. </span>
                    {{ $otherVehicleWithBrandAddon->quotationItem->description ?? ''}}
                </td>
                @if($quotationDetail->cb_name)
