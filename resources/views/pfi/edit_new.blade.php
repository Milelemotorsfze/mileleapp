                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control widthinput pfi-amount" value="{{old('amount', $pfi->amount)}}" readonly 
                                                    name="amount" min="0" placeholder="PFI Amount">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    cols="25">{{ old('comment', $pfi->comment)}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-1 col-md-6">
                                                                ...
                                                                id="pfi-quantity-{{ $key }}" oninput=calculateTotalAmount({{$key}}) placeholder="0"  name="pfi_quantities[]"
                                                                    class="form-control mb-2 widthinput pfi-quantities" value="{{old('pfi_quantity', $LOIItem->pfi_quantity)}}">
                                                            </div>
                                                            <div class="col-lg-1 col-md-6">
                                                            ...
                                                            <div class="col-lg-2 col-md-6">
                                                                ...
                                                                <input type="number" min="0"  required placeholder="0"
                                                                    ...
                                                                    id="unit-price-{{ $key}}" value="{{ old('unit_price', $LOIItem->unit_price)}}">
                                                            </div>
                                                            <div class="col-lg-2 col-md-6">
                                                                ...
                                                                <input type="number" min="0" readonly class="form-control mb-2 widthinput"
                                                                    id="total-amount-{{ $key }}" value="{{ $LOIItem->total_amount }}">
                                                            </div>                                                      
                                                        </div>
                                                    </div>
                                                </div>
