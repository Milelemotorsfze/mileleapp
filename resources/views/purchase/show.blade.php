                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <span> {{ $purchasingOrder->polPort->name  ?? '' }} / {{ $purchasingOrder->podPort->name ?? '' }} / {{ $purchasingOrder->fdCountry->name ?? '' }}</span>
                                ...
                                @php
                                $reservedIds = collect($vehicles)->pluck('booking_person_id')->filter()->unique()->toArray();
                                $reservedMap = [];
                                if (!empty($reservedIds)) {
                                        $reservedUsers = \App\Models\User::whereIn('id', $reservedIds)->get(['id','name']);
                                        foreach ($reservedUsers as $u) {
                                                $reservedMap[$u->id] = $u->name;
                                        }
                                }
                                ...
                                <div class="row">
                                        <div class="col-lg-4 col-md-3 col-sm-12">
                                                <label for="choices-single-default" class="form-label"><strong>Reserved Salesperson</strong></label>
                                        </div>
                                        <div class="col-lg-6 col-md-9 col-sm-12">
