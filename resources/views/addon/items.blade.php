                                ...
                                <div class="col-md-12 p-0">
                                    <div class="row">
                                        <div class="col-xxl-3 col-lg-6 col-md-12">
                                            ...
                                            <select name="kitSupplierAndPrice[1][supplier_id][]" id="kitSupplierDropdown1" multiple="true" style="width: 100%;">
                                        ...
                                        <div class="col-xxl-4 col-lg-3 col-md-3" id="div_price_in_aed_1" style="background-color: 	#F0F0F0;">
                                            ...
                                            <input readonly name="kitSupplierAndPrice[1][supplier_addon_purchase_price_in_aed]" id="Supplier1TotalPriceAED" type="text" class="leastPurchasePriceAED form-control form-control-sm @error('addon_purchase_price') is-invalid @enderror" placeholder="Enter Addons Purchase Price In AED , 1 USD = 3.6725 AED" value="{{ old('addon_purchase_price') }}"  autocomplete="addon_purchase_price" autofocus onkeyup="calculateUSD(1)">
                                        </div>
                                ...
                                <div class="col-md-12 apendNewItemHere1 p-0">
                                    <div class="row kitItemRowForSupplier1 kititemdelete">
                                        <div class="col-xxl-2 col-lg-6 col-md-12">
                                            ...
                                            <select class="form-control form-control-sm" name="kitSupplierAndPrice[1][kit_item_id][]" id="kitSupplier1Item1" multiple="true" style="width: 100%;">
    ...
    function addItemForSupplier(supplier)
    {
        ...
        $(".apendNewItemHere"+supplier).append(`
            <div class="row kitItemRowForSupplier${supplier} kititemdelete">
                <div class="col-xxl-2 col-lg-6 col-md-12">
                    <label for="choices-single-default" class="form-label font-size-13">Choose Items</label>
                    <select name="kitSupplierAndPrice[1][kit_item_id][]" id="kitSupplier${supplier}Item${index}" multiple="true" style="width: 100%;">
                        @foreach($kitItemDropdown as $kitItemDropdownData)
                            <option value="{{$kitItemDropdownData->id}}">{{$kitItemDropdownData->addon_code}}</option>
                        @endforeach
                    </select>                           
