              ...
              <div class="col-xxl-12 col-lg-12 col-md-12 col-sm-12" >
                ...
                @can('add-new-addon-selling-price')
                  ...
                  <button type="button" title="Create Selling Price" class="btn btn-success btn-sm " data-bs-toggle="modal" data-bs-target="#create-selling-price-{{$addonsdata->id}}">
                      <i class="fa fa-plus"></i> Create Selling Price
                    </button>
                                  ...
                                  <div class="row mt-2">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                      <div class="input-group">
                                        <input id="selling_price" type="number" min="0" step="any" class="form-control widthinput" 
                  ...
                  @elseif($addonsdata->SellingPrice)
                    <button type="button" title="Add New Selling Price" class="btn btn-success btn-sm " data-bs-toggle="modal" data-bs-target="#edit-selling-price-{{$addonsdata->SellingPrice->id}}">
                      <i class="fa fa-plus"></i> New Selling Price
                    </button>
                    ...
                    @else
                    <button type="button" class="btn btn-success btn-sm " data-bs-toggle="modal" data-bs-target="#edit-selling-price-{{$addonsdata->PendingSellingPrice->id}}">
                      <i class="fa fa-plus"></i> New Selling Price
                    </button>
