            ...
            <div class="row">
                <div class="col-xxl-9 col-lg-6 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <input id="purchase_price" type="text" class="form-control @error('purchase_price') is-invalid @enderror" name="purchase_price" placeholder="Enter Purchase Price" value="{{ $addonDetails->purchase_price }}" required autocomplete="purchase_price" autofocus>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <input id="lead_time" type="text" class="form-control @error('lead_time') is-invalid @enderror" name="lead_time" placeholder="Enter Lead Time" value="{{ $addonDetails->lead_time }}" required autocomplete="lead_time" autofocus>
                            @error('lead_time')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <textarea rows="5" id="additional_remarks" type="text" class="form-control @error('additional_remarks') is-invalid @enderror" name="additional_remarks" placeholder="Enter Additional Remarks" required autocomplete="additional_remarks" autofocus>{{ $addonDetails->additional_remarks }}</textarea>
                    ...
                    <div id="dynamic_field">
                        ...
                        <input type="text" name="addon_details_id[]"  value="{{ $AddonTypes->id }}" hidden>
                            <div class="col-xxl-5 col-lg-5 col-md-10">
                                <div class="row">
                                    <div class="col-xxl-12 col-lg-12 col-md-12">
                                    <input list="cityname1" id="title" type="text" class="form-control @error('brand') is-invalid @enderror" name="brand[]" placeholder="Choose Brand"  value="{{$AddonTypes->brand_id}}" required autocomplete="brand" autofocus>
