				...
				<div class="row mb-3" >
					...
					<div class="col-xxl-9 col-lg-5 col-md-11">
						...
						<input type="text" hidden name="description_text" id="description-text" placeholder="Enter Addon Description"
							value="" class="form-control widthinput @error('description') is-invalid @enderror"
							autofocus>
						@error('description')
						<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
			...
			<div class="card" id="partNumberDiv">
				...
				<div class="card-body">
					<div class="row partNumberMain">
						<div hidden>{{$i=0;}}</div>
						@foreach($addonDetails->partNumbers as $partNumbers)
						...
						<div class="col-xxl-4 col-lg-6 col-md-12 partNumberApendHere" id="row-{{$i}}">
							<div class="row">
								...
								<div class="col-xxl-3 col-lg-1 col-md-1">
									<a class="btn_round removePartNumber" data-index="{{$i}}" >
