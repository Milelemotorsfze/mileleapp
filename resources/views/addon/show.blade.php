            ...
            <div class="row">
                <div class="col-xxl-9 col-lg-6 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <input id="selling_price" type="text" class="form-control @error('selling_price') is-invalid @enderror" name="selling_price" placeholder="Enter Selling Price" value="{{ $addonDetails->selling_price }}" required autocomplete="selling_price" autofocus readonly>
                            @error('selling_price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
