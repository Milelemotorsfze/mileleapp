                                                        ...
                                                        <div class="col-md-12 p-0">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xxl-4 col-lg-3 col-md-3" id="div_price_in_aed_1" style="background-color: 	#F0F0F0;">
                                                                    ...
                                                                    <input readonly name="kitSupplierAndPrice[${index}][supplier_addon_purchase_price_in_aed]" id="Supplier${index}TotalPriceAED" type="number" min="0"
                                                                    step="any" class="leastPurchasePriceAED form-control widthinput @error('addon_purchase_price') is-invalid @enderror"
                                                                ...
                                                                <div class="col-xxl-4 col-lg-3 col-md-3" id="div_price_in_usd_1" style="background-color: 	 #F8F8F8;">
                                                                    ...
                                                                    <input readonly name="kitSupplierAndPrice[${index}][supplier_addon_purchase_price_in_usd]" id="Supplier${index}TotalPriceUSD"
                                                                     type="number" min="0" step="any" class="form-control purchase-price-USD widthinput @error('addon_purchase_price_in_usd') is-invalid @enderror" placeholder="Enter Addons Purchase Price In USD , 1 USD = 3.6725 AED" value="{{ old('addon_purchase_price_in_usd') }}"
                                                        ...
                                                        <div class="col-md-12 apendNewItemHere${index} p-0" id="kitItemRow">
                                                            <div class="row kitItemRowForSupplier${index} kititemdelete" id="kitItemSubRow">
                                                                ...
                                                                <div class="col-xxl-2 col-lg-3 col-md-3" id="div_price_in_aed_1" style="background-color: 	#F0F0F0;">
                                                                    ...
                                                                    <div class="input-group">
                                                                    <input  name="kitSupplierAndPrice[${index}][item][1][unit_price_in_aed]" id="Supplier${index}Kit1UnitPriceAED" type="number"
                                                                     min="0" step="any" class="form-control widthinput @error('addon_purchase_price') is-invalid @enderror unit-price-AED"
                                                                ...
                                                                <div class="col-xxl-2 col-lg-3 col-md-3" id="div_price_in_aed_1" style="background-color: 	#F0F0F0;">
                                                                    ...
                                                                    <div class="input-group">
                                                                    <input  name="kitSupplierAndPrice[${index}][item][1][total_price_in_aed]" id="Supplier${index}Kit1TotalPriceAED" type="number"
                                                                     min="0" step="any" class="Supplier${index}TotalPriceInAED form-control widthinput @error('addon_purchase_price') is-invalid @enderror total-price-AED"
                                                                ...
                                                                <div class="col-xxl-2 col-lg-3 col-md-3" id="div_price_in_usd_1" style="background-color: 	#F8F8F8;">
                                                                    ...
                                                                    <div class="input-group">
                                                                    <input  name="kitSupplierAndPrice[${index}][item][1][unit_price_in_usd]" id="Supplier${index}Kit1UnitPriceUSD" type="number"
                                                                     min="0" step="any" class="Supplier${index}TotalPriceInUSD form-control  widthinput @error('addon_purchase_price_in_usd') is-invalid @enderror unit-price-USD"
                                                                ...
                                                                <div class="col-xxl-2 col-lg- col-md-3" id="div_price_in_usd_1" style="background-color: 	#F8F8F8;">
                                                                    ...
                                                                    <div class="input-group">
                                                                    <input  name="kitSupplierAndPrice[${index}][item][1][total_price_in_usd]" id="Supplier${index}Kit1TotalPriceUSD" type="number" min="0"
                                                                    step="any" class="form-control widthinput total-price-USD @error('addon_purchase_price_in_usd') is-invalid @enderror"
