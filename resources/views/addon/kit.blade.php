                                ...
                                <div class="col-xxl-12 col-lg-12 col-md-12 form_field_outer">
                                    <div class="row">
                ...
                <script type="text/javascript">
                    ...
                    {
                        $("#itemArray1").attr("data-placeholder","Choose Addon Name....     Or     Type Here To Search....");
                        $("#itemArray1").select2({
                            ...
                            <div class="col-md-12 p-0">
                                <div class="col-md-12 p-0">
                                    <div class="row">
                                        <div class="col-xxl-5 col-lg-6 col-md-12">
                                            <label for="choices-single-default" class="form-label font-size-13">Choose Suppliers</label>
                                            <select name="supplierAndPrice[1][supplier_id][]" id="itemArray${index}" multiple="true" style="width: 100%;">
                                                @foreach($suppliers as $supplier)
                                                    <option class="{{$supplier->id}}" value="{{$supplier->id}}">{{$supplier->supplier}}</option>
                                                @endforeach
                                            </select>                           
            ...
            <div class="row">
                <div class="card-body">
                    <div class="col-xxl-12 col-lg-12 col-md-12">
                        <div class="row">
                            <div class="col-md-12 p-0">
                                <div class="col-md-12 form_field_outer1 p-0">
                                    <div class="row form_field_outer_row1">
                                        <div class="col-xxl-2 col-lg-6 col-md-12">
                                            <label for="choices-single-default" class="form-label font-size-13">Choose Items</label>
                                            <select class="form-control form-control-sm" name="supplierAndPrice[1][supplier_id][]" id="itemArrayss${index}" multiple="true" style="width: 100%;">
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-lg-12 col-md-12">
                                <a id="addSupplier" style="float: right;" class="btn btn-sm btn-info add_new_frm_field_btn_${index}"><i class="fa fa-plus" aria-hidden="true"></i> Add Item</a> 
                            </div>
                        </div>
                    </div>
                    </br>
                ...
                $("#itemArrayss"+index).attr("data-placeholder","Choose Supplier....     Or     Type Here To Search....");
                $("#itemArrayss"+index).select2({
                // maximumSelectionLength: 1,
            });
            $("#itemArray"+index).attr("data-placeholder","Choose Supplier....     Or     Type Here To Search....");
                $("#itemArray"+index).select2({
                // maximumSelectionLength: 1,
            });
        }); 
