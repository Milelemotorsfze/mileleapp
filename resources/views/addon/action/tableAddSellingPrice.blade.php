...
@if(!isset($addonsdata->SellingPrice) && !isset($addonsdata->PendingSellingPrice))
    ...
    <div class="modal fade" id="table-selling-price-{{$addonsdata->id}}"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <button type="button" title="Add New Selling Price" class="btn btn-success btn-sm " data-bs-toggle="modal" 
        data-bs-target="#edit-table-selling-price-{{$addonsdata->SellingPrice->id}}">
      <i class="fa fa-plus"></i> 
    </button>
    <div class="modal fade" id="edit-table-selling-price-{{$addonsdata->SellingPrice->id}}"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog ">
              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    @else
                    <button title="Add New Selling Price" type="button" class="btn btn-success btn-sm " data-bs-toggle="modal" data-bs-target="#edit-table-selling-price-{{$addonsdata->PendingSellingPrice->id}}">
                      <i class="fa fa-plus"></i> 
                    </button>
                    <div class="modal fade" id="edit-table-selling-price-{{$addonsdata->PendingSellingPrice->id}}"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog ">
