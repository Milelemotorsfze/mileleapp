                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row gy-3">
                                ...
                                <span class="error">* </span><label for="so_number"><span class="text-danger">*</span> Netsuit SO Number</label>
                                    ...
                                    <div class="col-md-12 mt-3" id="so-vehicles">
                                        ...
                                        <div class="so-variant-add-section " id="variant-section-{{ $key + 1 }}">
                                            <div class="row">
                                                ...
                                                <span class="error">* </span><label class="form-label font-size-13">Choose Variant</label>
                                                ...
                                                <span class="error">* </span><label class="form-label font-size-13">Description</label>
                                                ...
                                                <span class="error">* </span><label class="form-label font-size-13">Price</label>
                                                ...
                                                <div class="col-sm-12 col-md-2 col-lg-2 col-xxl-2">
                                                <span class="error">* </span><label class="form-label font-size-13">Quantity</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                            <span class="error">* </span><label for="payment_so"><strong>Payment In SO</strong></label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="rejectForm">
                            <div class="mb-3">
                            <span class="error">* </span><label for="reason" class="form-label">Rejection Reason</label>
