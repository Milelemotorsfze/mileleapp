...
<style>
	...
	.btn_round {
		width: 30px; height: 30px; display: inline-block; text-align: center; line-height: 35px; margin-left: 10px; margin-top: 28px; border: 1px solid #ccc; color:#fff;
		background-color: #fd625e; border-radius:5px; cursor: pointer;padding-top:7px;
	}
	.btn_round:hover {
		color: #fff; background: #fd625e; border: 1px solid #fd625e;
	}
	.paragraph-class {
		margin-top: .25rem; font-size: 80%; color: #fd625e;
	}
	.overlay {
													...
													<div class="row kitMainItemRowForSupplier kititemdelete" id="item-1">
														...
														<div class="col-xxl-1 col-lg-3 col-md-3" id="div_price_in_usd_1" >
															...
															<input name="mainItem[1][quantity]" id="mainQuantity1" placeholder="Enter Quantity" type="number" value="1" min="1"
																class="form-control widthinput quantityMainItem" autofocus oninput="validity.valid||(value='1');" required >
	        ...
	        <div class="row kitMainItemRowForSupplier kititemdelete" id="item-${index}">
	            ...
	            <div class="col-xxl-1 col-lg-3 col-md-3" id="div_price_in_usd_1" >
	                ...
	                <input name="mainItem[${index}][quantity]" id="mainQuantity${index}"
	                    ...
	                    placeholder="Enter Quantity" autocomplete="addon_purchase_price_in_usd" autofocus oninput="validity.valid||(value='1');" required >
