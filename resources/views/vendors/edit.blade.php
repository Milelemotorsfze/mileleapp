...
@section('content')
    ...
    <div class="card-body">
        ...
        @endif
        <form id="form-create" action="{{ route('vendors.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="vendor_type" autofocus>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="category" >
                                    <option value="IT" {{ $vendor->vendor_type == 'IT' ? 'selected' : '' }}>IT</option>
                                    <option value="vehicle-procurment" {{ $vendor->vendor_type == 'vehicle-procurment' ? 'selected' : '' }}>Vehicle Procurment</option>
                                    <option value="parts-procurment" {{ $vendor->vendor_type == 'parts-procurment' ? 'selected' : '' }}>Parts Procurment</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('trade_name_or_individual_name') is-invalid @enderror"
                                       ...
                                       value="{{ old('trade_name_or_individual_name', $vendor->trade_name_or_individual_name) }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                <label for="choices-single-default" class="form-label">comment</label>
                                <textarea cols="25" rows="5" class="form-control" name="comment" placeholder="comment">{{ old('comment', $vendor->comment) }}
                                </textarea>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="web_address" placeholder="Web Address"
                                       value="{{ old('web_address', $vendor->web_address) }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="primary_subsidiary" placeholder="Primary Subsidiary"
                                       value="{{ old('primary_subsidiary', $vendor->primary_subsidiary) }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('business_registration') is-invalid @enderror"
                                       ...
                                       value="{{ old('business_registration', $vendor->business_registration) }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="reference" placeholder="Reference"
                                       value="{{ old('reference', $vendor->reference) }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="passport_number" placeholder="Passport Number"
                                       value="{{ old('passport_number', $vendor->passport_number) }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nationality" placeholder="Nationality"
                                       value="{{ old('nationality', $vendor->nationality) }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="trade_license_number" placeholder="Trade License Number"
                                       value="{{ old('trade_license_number', $vendor->trade_license_number) }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="trade_registration_place" placeholder="Trade Registration Place"
                                       value="{{ old('trade_registration_place', $vendor->trade_registration_place) }}">
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="passport-upload" name="passport_copy_file"
                                                   ...
                                                   value="{{ old('passport_copy_file', $vendor->passport_copy_file) }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="trade-licence-upload" name="trade_license_file"
                                                   ...
                                                   value="{{ old('trade_license_file', $vendor->trade_license_file) }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="vat-certificate-upload" name="vat_certificate_file"
                                                   ...
                                                   value="{{ old('vat_certificate_file', $vendor->vat_certificate_file) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="fax" placeholder="fax" value="{{ old('fax', $vendor->fax) }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('preference_id') is-invalid @enderror"
                                       name="preference_id" placeholder="Preference ID" value="{{ old('preference_id', $vendor->preference_id) }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('label') is-invalid @enderror"
                                       name="label" placeholder="Label" value="{{ old('label', $vendor->label) }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="email_preference" autofocus>
                                    <option value="default" {{ $vendor->email_preference == 'default' ? 'selected' : '' }}>Default</option>
                                    <option value="yes" {{ $vendor->email_preference == 'yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="no" {{ $vendor->email_preference == 'no' ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="print_on_check_as" placeholder="Print On Check Us"
                                       value="{{ old('print_on_check_as', $vendor->print_on_check_as) }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="send_transaction_via" autofocus>
                                    <option value="email" {{ $vendor->send_transaction_via == 'email' ? 'selected' : '' }}>Email</option>
                                    <option value="print" {{ $vendor->send_transaction_via == 'print' ? 'selected' : '' }}>Print</option>
                                    <option value="fax" {{ $vendor->send_transaction_via == 'fax' ? 'selected' : '' }}>Fax</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="notes" placeholder="Notes" value="{{ old('notes', $vendor->notes) }}">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                <label for="choices-single-default" class="form-label">Address</label>
                                <textarea cols="25" rows="5" class="form-control" name="address" placeholder="Address">{{ old('address', $vendor->address) }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                <label for="choices-single-default" class="form-label">Default Shipping Address</label>
                                <textarea cols="25" rows="5" class="form-control" name="default_shipping_address" placeholder="Shipping Address">{{ old('default_shipping_address', $vendor->default_shipping_address) }}
                                </textarea>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea cols="25" rows="5" class="form-control" name="default_billing_address" placeholder="Billing Address">{{ old('default_billing_address', $vendor->default_billing_address) }}
                                </textarea>
                            </div>
                        </div>
                    </div>
