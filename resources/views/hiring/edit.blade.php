...
@section('content')
    <div class="card-header">
        <h4 class="card-title">Edit Request for Hiring</h4>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 btncenter">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <input type="text" name="job_title" placeholder="Enter Job TItle" class="form-control" value="{{ $hiring->job_title }}">
                        </div>
    					<div class="col-lg-12 col-md-12">
    					...
    					<div class="col-lg-12 col-md-12">
                            ...
                            <input type="text" name="job_role" placeholder="Enter Role of the Candidate" class="form-control" value="{{ $hiring->job_role }}">
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <label for="basicpill-firstname-input" class="form-label">Education</label>
                            <input type="text" name="job_education" placeholder="Enter Higher Education Require" class="form-control" value="{{ $hiring->job_education }}">
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <label for="basicpill-firstname-input" class="form-label">Experaince</label>
                            <input type="text" name="job_experiance" placeholder="Enter Experaicne in Years" class="form-control" value="{{ $hiring->job_experiance }}">
                        </div>
                        <div class="col-lg-12 col-md-12">
    		        ...
    		        <div class="col-lg-6 col-md-6 btncenter">
                        <input type="submit" name="submit" value="UPDATE" class="btn btn-success btn-sm btncenter" />
    		        </div>
                </div>
            </form>
		</br>
