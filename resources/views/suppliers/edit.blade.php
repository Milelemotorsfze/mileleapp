...
@section('content')
    ...
    <div class="card-body">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('suppliers.store') }}"> 
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <input id="supplier" type="text" class="form-control @error('supplier') is-invalid @enderror" name="supplier" placeholder="Enter Supplier" value="{{ $supplier->supplier }}"  autocomplete="supplier" autofocus>
                            @error('supplier')
                ...
                <div class="col-xxl-6 col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <input id="contact_number" type="tel" class="form-control @error('contact_number') is-invalid @enderror" name="contact_number[main]" placeholder="Enter Contact Number" value="{{ $supplier->contact_number }}"  autocomplete="contact_number" autofocus>
                ...
                <div class="col-xxl-6 col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <input id="alternative_contact_number" type="text" class="form-control @error('alternative_contact_number') is-invalid @enderror" name="alternative_contact_number[main]" placeholder="Enter Alternative Contact Number" value="{{ $supplier->alternative_contact_number }}" autocomplete="alternative_contact_number" autofocus>
                ...
                <div class="col-xxl-6 col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Enter Email" value="{{ $supplier->email }}"  autocomplete="email" autofocus>
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="col-xxl-6 col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <select name="supplier_type" id="supplier_type" class="form-control">
                            ...
                            <option value="accessories" {{ $supplier->supplier_type == "accessories" ? 'selected' : '' }}>Accessories</option>      
                            <option value="freelancer" {{ $supplier->supplier_type == "freelancer" ? 'selected' : '' }}>Freelancer</option>
                            <option value="garage" {{ $supplier->supplier_type == "garage" ? 'selected' : '' }}>Garage</option>
                            <option value="spare_parts" {{ $supplier->supplier_type == "spare_parts" ? 'selected' : '' }}>Spare Parts</option>
                        </select>
                        </div>
                    </div>
                    </br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-lg-6 col-md-12">
                            <select id="is_primary_payment_method" name="is_primary_payment_method" class="form-control" onchange="secondaryPaymentMethods()">
                                ...
                                <option value="{{$paymentMethod->id}}" {{ $paymentMethod->id == $primaryPaymentMethod->id ? 'selected' : '' }}>{{$paymentMethod->payment_methods}}</option>
                                @endforeach
                            </select>
            ...
            @if($paymentMethod->id != $primaryPaymentMethod->id)
                            @endif
            <div class="tab">
                <h6 class="tablinks" onclick="openCity(event, 'London')" id="defaultOpen">Add Supplier Addons</h6>
                <h6 class="tablinks" onclick="openCity(event, 'Paris')">Upload Supplier's Addon Excel</h6>
            </div>
                                    ...
                                    <div class="col-md-12 form_field_outer p-0">
                                        <div class="row form_field_outer_row">
                                            <div class="col-xxl-6 col-lg-6 col-md-12">
                                                ...
                                                <select class="addonClass" id="adoon_1" name="addon_id_1[]" multiple="true" style="width: 100%;" onchange="changeAddon(1)">
            ...
            <div id="Paris" class="tabcontent">
                <center>
                    <input style="width:50%;" id="image" type="file" class="form-control" name="image" required autocomplete="image" />
                </center>
            </div>
            </br>
            <div class="col-xxl-12 col-lg-12 col-md-12">
            ...
            { 
                var index = $(".form_field_outer").find(".form_field_outer_row").length + 1; $(".form_field_outer").append(`
                    <div class="row form_field_outer_row">
                        <div class="col-xxl-6 col-lg-6 col-md-12">
                            <label for="choices-single-default" class="form-label font-size-13">Choose Addons</label>
                            <select class="addonClass"  id="adoon_${index}" name="addon_id_${index}[]" multiple="true" style="width: 100%;" onchange="changeAddon(${index})">
                                @foreach($addons as $addon)
                        ...
                        <div class="col-xxl-1 col-lg-1 col-md-1">
                            <label for="choices-single-default" class="form-label font-size-13">Currency</label>
                            <select name="currency" id="currency_${index}" class="form-control" onchange="changeCurrency(${index})">
                                <option value="AED">AED</option>      
                                <option value="USD">USD</option>
                            </select>
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-3" id="div_price_in_usd_${index}" hidden>
                            <label for="choices-single-default" class="form-label font-size-13 ">Purchase Price In USD</label>
                            <input id="addon_purchase_price_in_usd_${index}" type="text" class="form-control @error('addon_purchase_price_in_usd') is-invalid @enderror" name="addon_purchase_price_in_usd" placeholder="Enter Addons Purchase Price In USD" value="{{ old('addon_purchase_price_in_usd') }}"  autocomplete="addon_purchase_price_in_usd" autofocus onkeyup="calculateAED(${index})">
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-3" id="div_price_in_aed_${index}" hidden>
                            <label for="choices-single-default" class="form-label font-size-13 ">Purchase Price In AED</label>
                            <input id="addon_purchase_price_${index}" type="text" class="form-control @error('addon_purchase_price') is-invalid @enderror" name="addon_purchase_price" placeholder="1 USD = 3.6725 AED" value="{{ old('addon_purchase_price') }}"  autocomplete="addon_purchase_price" autofocus readonly>
                        </div>
                        <div class="col-xxl-4 col-lg-6 col-md-6" id="div_price_in_aedOne_${index}">
                            <label for="choices-single-default" class="form-label font-size-13 ">Purchase Price In AED</label>
                            <input id="addon_purchase_price_${index}" type="text" class="form-control @error('addon_purchase_price') is-invalid @enderror" name="addon_purchase_price" placeholder="Enter Addons Purchase Price in AED" value="{{ old('addon_purchase_price') }}"  autocomplete="addon_purchase_price" autofocus>
                        </div>
                        <div class="form-group col-xxl-1 col-lg-1 col-md-1 add_del_btn_outer">
                            <button class="btn_round add_node_btn_frm_field" title="Copy or clone this row">
                                <i class="fas fa-copy"></i>
